	...
	execute(message, args) {
        ...
        async function postEmbed (boorus, posts) {
            ...
            filteredTags = [//Removed: "bandaids_on_nipples","dakimakura","undressing","x3"
                ...
                "cow_ears","cowboy_shot","cowgirl_position","crazy","crazy_smile","cream","creature","crinoline","crop_top","cropped","cropped_legs","cross","crossed_arms","crown","crying","cuffs","cum","cum_in_mouth","cum_in_pussy","cum_inflation","cum_on_body","cum_on_breasts","cum_on_fingers","cum_on_hair","cum_on_hands","cum_on_mouth","cum_on_pussy","cum_on_upper_body","cumdrip","cup","curtains",
                "d:","dark_skin","dark-skinned_female","dark-skinned_male","day","deletethistag","demon","demon_girl","depressed","detached_sleeves","desk","despair","digital_version","dildo","disdain","disgust","dissapointed","dog","doggystyle","door","double_bun","doyagao","dress","dress_shirt","drolling","drunk","dutch_angle",
